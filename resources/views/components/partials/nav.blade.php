        ...
        <div class="flex items-center justify-between h-16 space-x-12">
            <div class="flex">
                ...
                <div class="flex items-center flex-shrink-0">
                    <a href="{{ route('home') }}">
                        <x-logos.main class="block w-auto h-8" />
                    </a>
                </div>
            ...
            <div>
                ...
                <a href="{{ route('threads.create') }}" class="hover:text-blue-500 transition-colors duration-30" >
                    {{ __('Start a new discussion') }}
                </a>
            </div>

            <div>
                {{-- View  Discussons Button --}}
                <a href="{{ route('threads.index') }}"  class="hover:text-blue-500 transition-colors duration-30"  >
                    {{ __('See all the discussions') }}
                </a>
            </div>
